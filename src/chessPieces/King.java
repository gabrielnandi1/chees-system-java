...
public class King extends ChessPiece {
    ...
    public King(Board board, Color white) {
        super(board, white);
    ...
    public boolean[][] possibleMoves() {
        ...
        // Verificar se a posicoes livres nordeste da peca
        p.setValues(position.getRow() - 1, position.getColumn() + 1);
        if (getBoard().positionExists(p) && canMove(p)) {
            mat[p.getRow()][p.getColumn()] = true;
        }
        // Verificar se a posicoes livres sudoeste da peca
        p.setValues(position.getRow() + 1, position.getColumn() - 1);
        if (getBoard().positionExists(p) && canMove(p)) {
            mat[p.getRow()][p.getColumn()] = true;
        }
        // Verificar se a posicoes livres sudeste da peca
        p.setValues(position.getRow() + 1, position.getColumn() + 1);
        if (getBoard().positionExists(p) && canMove(p)) {
            mat[p.getRow()][p.getColumn()] = true;
        }
